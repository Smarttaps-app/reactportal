  ...
  return (
    <Layout style={{ minHeight: "100vh" }}>
      ...
      >
        ...
        <Link to="auth/login" className="p-1 font-normal !text-white">
          Login
        </Link>
      </Header>
      <Content>
        <Home />
        <HowToPlay />
        <section className="bg-orange-500 py-12 !px-12 text-center">
          <h2 className="text-3xl font-bold mb-4">Download Our App</h2>
          <p className="text-gray-600 mb-6">
            Get the best experience on your Android or iOS device.
          </p>
          ...
          <div className="flex justify-center gap-4 flex-wrap">
            ...
            >
              <img src={google} alt="Get it on Google Play" className="h-6" />
      ...
      <Footer
        className="!bg-[#1b2441]  !text-white py-1 lg:py-3"
        style={{ textAlign: "center" }}
      >
        <Flex justify="space-between" className="px-10 !text-white">
          <Flex>
            <Typography className="text-center font-normal  !text-white">
              {import.meta.env.VITE_APP_NAME} &copy; {new Date().getFullYear()}
            </Typography>
            <Link to="#"> &nbsp; Created by Altswitch Technology</Link>
          </Flex>
          <div className="flex gap-5 justify-center !text-white text-center sm:justify-center">
            <Typography className="opacity-80 text-md font-bold  !text-white transition-opacity hover:opacity-100">
              <svg
                className="size-5"
                fill="currentColor"
                viewBox="0 0 24 24"
          ...
          <Flex gap={10}>
            ...
            <Link className="!text-white" to="/term-and-conditions">
              {" "}
              Terms and Agreement
            </Link>
